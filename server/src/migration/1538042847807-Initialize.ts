...
export class Initialize1538042847807 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        // await queryRunner.query(`CREATE TABLE "image" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "extension" varchar NOT NULL, "originalName" varchar NOT NULL, "dateAdded" datetime NOT NULL DEFAULT (datetime('now')), "description" varchar, "dateFrom" datetime, "dateTo" datetime, "parentFolderId" integer, "placeId" integer)`);
        ...
        // await queryRunner.query(`CREATE TABLE "temporary_image" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "extension" varchar NOT NULL, "originalName" varchar NOT NULL, "dateAdded" datetime NOT NULL DEFAULT (datetime('now')), "description" varchar, "dateFrom" datetime, "dateTo" datetime, "parentFolderId" integer, "placeId" integer, CONSTRAINT "FK_a4784e0e64c5e2fabd692116287" FOREIGN KEY ("parentFolderId") REFERENCES "folder" ("id"), CONSTRAINT "FK_9ad0d872c1a54866d27b469a4e8" FOREIGN KEY ("placeId") REFERENCES "place" ("id"))`);
        // await queryRunner.query(`INSERT INTO "temporary_image"("id", "name", "extension", "originalName", "dateAdded", "description", "dateFrom", "dateTo", "parentFolderId", "placeId") SELECT "id", "name", "extension", "originalName", "dateAdded", "description", "dateFrom", "dateTo", "parentFolderId", "placeId" FROM "image"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        // await queryRunner.query(`CREATE TABLE "image" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "extension" varchar NOT NULL, "originalName" varchar NOT NULL, "dateAdded" datetime NOT NULL DEFAULT (datetime('now')), "description" varchar, "dateFrom" datetime, "dateTo" datetime, "parentFolderId" integer, "placeId" integer)`);
        // await queryRunner.query(`INSERT INTO "image"("id", "name", "extension", "originalName", "dateAdded", "description", "dateFrom", "dateTo", "parentFolderId", "placeId") SELECT "id", "name", "extension", "originalName", "dateAdded", "description", "dateFrom", "dateTo", "parentFolderId", "placeId" FROM "temporary_image"`);
