...
export class ExplorerController {
    ...
    async relocateFolder(@Body() body: {oldPath: string, newPath: string}): Promise<FolderDto> {
        ...
        if (targetFolder) {
            ...
            return this.transformer.transform(targetFolder, FolderDto);
        }
        ...
        return this.transformer.transform(sourceFolder, FolderDto);
    }
    ...
    async relocateImage(@Body() body: {oldPath: string, newPath: string}): Promise<ImageDto> {
        ...
        return this.transformer.transform(sourceImage, ImageDto);
    }
}
